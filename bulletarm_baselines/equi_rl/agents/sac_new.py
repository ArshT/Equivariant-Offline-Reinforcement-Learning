...
class SAC_2(A2CBase):
    ...
    def calcCriticLoss(self):
        ...
        return qf1_loss, qf2_loss, td_error,avg_q_values_1, avg_q_values_2
    ...
    def updateCritic(self):
        ...
        :return: q1 loss, q2 loss, td error
        """
        qf1_loss, qf2_loss, td_error, avg_q_values_1, avg_q_values_2 = self.calcCriticLoss()
    ...
    def update(self, batch):
        ...
        qf1_loss, qf2_loss, td_error, avg_q_values_1, avg_q_values_2 = self.updateCritic()
        ...
        return qf1_loss.item(), qf2_loss.item(), policy_loss.item(), alpha_loss.item(), alpha_tlogs.item(), td_error, avg_q_values_1, avg_q_values_2
